  ...
  const HomeRightbar = () => {
    return (
      <>
        ...
        />
        <p className="promotionTitle">ショッピング</p>
        <img
          src={PUBLIC_FOLDER + "/promotion/promotion2.jpeg"}
          alt=""
          className="rightbarPromotionImg"
        />
        <p className="promotionTitle">カーショップ</p>
        <img
    ...
    return (
      <>
        ...
        <div className="rightbarInfo">
          <div className="rightbarInfoItem"><span className="rightbarInfoKey">出身</span><span className="rightbarInfoKey">福岡</span></div>
          ...
          <div className="rightbarFollowings">
            ...
            <div className="rightbarFollowing">
              <img
                ...
                className="rightbarFollowingImg"
              />
              <span className="rightbarFollowingName">Oomi</span>
            </div>
          </div>
        </div>
      </>
